...
const FUN_TOPICS = [
  ...
  { id: "silly", icon: "🤪", vi: "Nói chuyện vô tri", en: "Silly talk", desc: "Tám chuyện trời ơi đất hỡi", seed: "[TOPIC: Absurd, silly, meme-y nonsense chat — keep it light, funny, zero stakes]", hue: "#C98A3A",
    openers: [
      ["Important question: if you were a vegetable, which one would you be, and why?", "Câu hỏi quan trọng nè: nếu bạn là một loại rau củ, bạn sẽ là rau gì, và vì sao?"],
      ["Okay be honest: how many hot dogs could you eat in one sitting?", "Thành thật nhé: một lần ngồi bạn ăn được bao nhiêu cái xúc xích?"],
      ["Burning question: would you rather fight one horse-sized duck or a hundred duck-sized horses?", "Câu hỏi nhức nhối: bạn chọn đánh một con vịt to bằng ngựa, hay một trăm con ngựa bé bằng vịt?"],
      ["Quick! You just won a llama. What do you name it?", "Nhanh nào! Bạn vừa trúng thưởng một con lạc đà. Bạn đặt tên nó là gì?"],
    ],
  ...
  { id: "partner", icon: "💑", vi: "Người yêu giận dỗi", en: "Couple's spat", desc: "Cãi yêu chuyện việc nhà", seed: "[TOPIC: A playful, comedic partner having a light-hearted lovers' spat — PG, funny, affectionate, never sexual or cruel]", hue: "#D17BA0",
    openers: [
      ["Babe, seriously? I did the dishes three times this week. When was the last time YOU took out the trash, hmm?", "Cưng ơi, thật hả? Tuần này tớ rửa bát ba lần rồi đó. Lần cuối CẬU đổ rác là khi nào, hửm?"],
      ["Okay, who ate the last slice of cake I was saving? Don't lie to me!", "Được rồi, ai ăn miếng bánh cuối cùng tớ để dành thế? Đừng nói dối tớ nha!"],
      ["You said five more minutes... an hour ago. We're so late! What happened?", "Cậu bảo năm phút nữa... từ một tiếng trước. Trễ lắm rồi đó! Sao vậy?"],
      ["Hmm, you've been on your phone all dinner. Is something more interesting than me?", "Hừm, cả bữa tối cậu cứ dán mắt vào điện thoại. Có gì thú vị hơn tớ à?"],
    ],
